...
void MILPcons::wXorC1(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &dCounter) {
...
void MILPcons::wXorC2(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::wAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::wLinearC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx, int &dCounter,
...
void MILPcons::wLinearC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx, int &dCounter,
                         int branchMin, int branchMax) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::bXorC1(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &dCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::bXorC2(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::bXorC3(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &dCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::bMatrixEntryC12(std::string path, std::vector<std::vector<int>> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::bNXorC3(std::string path, std::vector<int> inputIdx, int outputIdx, int &yCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::bMatrixEntryC3(std::string path, std::vector<std::vector<int>> inputIdx, std::vector<int> outputIdx,
                              std::vector<int> overflows, std::vector<int> module, int &xCounter, int &yCounter,
                              int &fCounter) {
    std::vector<int> output;
    for (int i = 0; i < outputIdx.size(); ++i) {
...
void MILPcons::bSboxC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::bSboxC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::bSboxC3(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::bAddC(std::string path, std::vector<int> inputIdx1, std::vector<int> inputIdx2, std::vector<int> outputIdx,
...
void MILPcons::bAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::dSboxC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::dSboxC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::dSboxC3(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void MILPcons::dAddC(std::string path, std::vector<int> inputIdx1, std::vector<int> inputIdx2, std::vector<int> outputIdx,
                std::vector<std::vector<int>> ineqs, int &dCounter, int &PCounter) {
    int addSize = inputIdx1.size();
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void MILPcons::dAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &PCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
        std::cout << "Wrong file path of bAndC1 ! " << std::endl;
    } else {
